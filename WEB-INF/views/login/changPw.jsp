...
<div class="login-form">
    <form action="/updateUserPw" method="post">
        ...
        <h4 class="modal-title">Change to Your Password</h4>

        <div class="form-group">
            <p>username</p>
            <input type="text" class="form-control" placeholder="Confirm username" required="required" name="user_name">
        </div>
        <div class="form-group">
            <p>useremail</p>
            <input type="text" class="form-control" placeholder="Confirm useremail" required="required"
                   name="user_email">
        </div>
        <div class="form-group">
            <p>Password</p>
